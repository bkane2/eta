...
:episodes (
  ...
  ;; ?e15 (^me paraphrase-to.v ^you '(It\'s really difficult to hear that my cancer has spread\, but I\'m glad you\'re here to help answer my questions \.))

  ?e15 ((set-of ^me ^you) acknowledge-empathy.v)

  ?e16 (^me say-to.v ^you '([NEUTRAL] Let\'s pause here for feedback on this conversation \.))
