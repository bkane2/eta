...
'(
  ...
  1 (:or
    ...
    (0 Do I have any questions about my prognosis 0)
    (0 Do I have any question about my treatment options 0)
    (0 What do I understand about my treatment options 0)
    ;;; Treatment goals
    (0 Do I want to try and fight the cancer 0)
    (0 Do I want to try to fight the cancer 0)
    ;;; Test results
    (0 Do I want my family to be here when you tell me about the test results 0)
