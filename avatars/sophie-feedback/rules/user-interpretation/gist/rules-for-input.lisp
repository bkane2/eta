...
'(
  ...
  1 (WH_ does this mean for my future [SEP] 0)
    ...
    2 (0 [SEP] 0 WH_ worries me the most 0)
  ...
  1 (What is 1 prognosis [SEP] 0)
    2 (0 [SEP] 0 Do I understand my prognosis 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 (0 [SEP] 0 How much information do I want 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 (0 [SEP] 0 What scares me about my prognosis 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 (0 [SEP] 0 How do I feel about my prognosis 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 ((Question-Suggestion \: How much information do you want about your prognosis ? What concerns you the most for your future ?)) (0 :gist)
  ...
  1 (What are my options for treatment [SEP] 0)
    2 (0 [SEP] 0 What scares me about my condition 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 (0 [SEP] 0 How am I feeling about my condition 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 (0 [SEP] 0 What are my treatment goals 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
  ...
  ;  2 (0 [SEP] 0 How am I feeling about my condition 0)
  ;    3 ((The doctor asked an open ended question \.)) (0 :gist)
  ;  2 (0 [SEP] 0 Was I nervous for this appointment 0)
  ;    3 ((The doctor asked an open ended question \.)) (0 :gist)
  ...
  ;  2 (0 [SEP] 0 Was I nervous for this appointment 0)
  ;    3 ((The doctor asked an open ended question \.)) (0 :gist)
  ;  2 (0 [SEP] 0 What happens when I try to sleep 0)
  ;    3 ((The doctor asked an open ended question \.)) (0 :gist)
  ...
  1 (What should I tell my family [SEP] 0)
    2 (0 [SEP] 0 Do I want you to be present when I tell my family about the prognosis 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 I should reassure my family about the prognosis 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 I should tell my family the full truth about the prognosis 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
  ...
  1 (I know that my cancer has gotten worse\, but I\'m not sure how bad it is [SEP] 0)
    ...
    2 (0 [SEP] 0 What scares me about my prognosis 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 How much do I want to know about my prognosis 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 Was I nervous about this meeting 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 ((Empathy-Suggestion \: How much do you want to know about your prognosis ? Were you nervous about this meeting ?)) (0 :gist)

  1 (Why have I not been sleeping well [SEP] 0)
    2 (0 [SEP] 0 Is my mental health keeping me awake 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 What is on my mind when I try to sleep 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 Can I tell you about my pain 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 How do I rate my pain 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
  ...
  1 (My pain has recently been getting worse [SEP] 0)
    ...
    2 (0 [SEP] 0 How do I rate my pain 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 Do I want a stronger pain medication 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 Is my pain medication working 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
  ...
  1 (I feel mildly depressed [SEP] 0)
    2 (0 [SEP] 0 How is my mental health 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 Is something harming my mental health 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 What scares me about my condition 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 How am I feeling about my condition 0)
  ...
  1 (I feel anxious about my future [SEP] 0)
    ...
    2 (0 [SEP] 0 Was I nervous for this appointment 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 I should see a therapist 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 I should take an antidepressant 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (Empathy-Suggestion \: How is your mental health? Were you nervous for this appointment ?) (0 :gist)
    
  1 (Why do I have cancer [SEP] 0)
    2 (0 [SEP] 0 You wish that I do not have cancer 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 You are sorry that I have cancer 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
