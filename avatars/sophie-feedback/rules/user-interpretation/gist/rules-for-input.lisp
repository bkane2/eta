...
'(
  ...
  1 (Why have I not been sleeping well [SEP] 0)
    ...
    2 (0 [SEP] 0 What happens when you try to sleep 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 ((Suggestion \: Were you nervous about this meeting ? Can you elaborate on your sleeping problems ?)) (0 :gist)
  1 (What is 1 prognosis [SEP] 0)
    ...
    2 (0 [SEP] 0 How do your feel about your prognosis 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 ((Suggestion \: Do you understand your prognosis ? How much information do you want about your prognosis ? What concerns you the most for your future ?)) (0 :gist)
  1 (Can I trust your prognosis [SEP] 0) 
    2 (0 [SEP] 0 Do you understand your prognosis 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 (0 [SEP] 0 How do you feel about your prognosis 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 ((Suggestion \: Do you understand your prognosis ? What concerns you the most for your future ?)) (0 :gist)
  1 (What are my options for treatment [SEP] 0)
    ...
    2 (0 [SEP] 0 What are your treatment goals 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 ((Suggestion \: What concerns you the most for your future ? What are your treatment goals ?)) (0 :gist)
  ; New Addition
  1 (I feel mildly depressed [SEP] 0)
    ...
    2 (0 [SEP] 0 Were you nervous for this appointment 0)
      3 ((The doctor asked an open ended question \.)) (0 :gist)
    2 ((Suggestion \: What concerns you the most for your future ? What scares you about your condition ? Were you nervous about this meeting ?)) (0 :gist)
  ...
  1 (What should I tell my family [SEP] 0)
    ...
    2 (0 [SEP] 0 You should tell your family the full truth about the prognosis 0)
      3((The doctor gave an empathetic response \.)) (0 :gist)
    2 ((Suggestion \: Do you want me to be present when you tell your family about the prognosis ? I\'ll be there for you throughout the whole process \.)) (0 :gist)
  1 (I know that my cancer has gotten worse\, but I\'m not sure how bad it is [SEP] 0)
    ...
    2 ((Suggestion \: How much do you want to know about your prognosis ? Were you nervous about this meeting ?)) (0 :gist)
  1 (Why have I not been sleeping well [SEP] 0)
    ...
    2 (0 [SEP] 0 How do you rate your pain 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 I am sorry that you are sleeping poorly \.)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 ((Suggestion \: What goes through your mind when you try to sleep ? Do you feel pain at night ? I\'m sorry that you\'ve been sleeping poorly \.)) (0 :gist)
  1 (My pain has recently been getting worse [SEP] 0)
    ...
    2 (0 [SEP] 0 Do you have the pain frequently 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 ((Suggestion \: I am sorry that you are in pain \. Can you tell me about your pain ? Has the pain become worse ?)) (0 :gist)
  1 (I feel mildly depressed [SEP] 0)
    ...
    2 (0 [SEP] 0 Were you nervous for this appointment 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (Suggestion \: How have you been recently? Were you nervous for this appointment ?) (0 :gist)
  1 (I feel anxious about my future [SEP] 0)
    ...
    2 (0 [SEP] 0 You should take an antidepressant 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (Suggestion \: How is your mental health? Were you nervous for this appointment ?) (0 :gist)
  1 (Why do I have cancer [SEP] 0)
    2 (0 [SEP] 0 I wish that you do not have cancer 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (0 [SEP] 0 I am sorry that you have cancer 0)
      3 ((The doctor gave an empathetic response \.)) (0 :gist)
    2 (Suggestion \: I\'m so sorry that this happened to you\. I wish that there was no such thing as cancer at all \.) (0 :gist)
