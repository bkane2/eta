...
; ``````````````````````````````````````````````````````````````````
  ...
  1 (0 a side .EFFECT of the medication .BE 2 .SIDE-EFFECTS-SIGNIFICANT 0)
    2 *refuse-stronger-pain-medication* (100 :schema)
  1 (0 a side .EFFECT of the medication .BE 2 .SIDE-EFFECTS-MODERATE 0)
    2 *accept-stronger-pain-medication* (100 :schema)
...
; ``````````````````````````````````````````````````````````````````
  ...
  ;; Replaced 'ask about treatment options' schema with 'explain treatment goals' schema for more robust response.
