;; ASDF system definition for information-retrieval
...
;; Load information-retrieval Choose between the following two lines depending on
;; whether you want the files compiled into FASLs or not:
;; (asdf:operate 'asdf:load-op 'information-retrieval) ;; Compile and load as necessary
(asdf:operate 'asdf:load-source-op 'information-retrieval) ;; Doesn't compile
