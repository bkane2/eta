;; ASDF system definition for lenulf
...
;; Load lenulf Choose between the following two lines depending on
;; whether you want the files compiled into FASLs or not:
;; (asdf:operate 'asdf:load-op 'lenulf) ;; Compile and load as necessary
(asdf:operate 'asdf:load-source-op 'lenulf) ;; Doesn't compile
