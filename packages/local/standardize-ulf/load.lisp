;; ASDF system definition for standardize-ulf
...
;; Load standardize-ulf Choose between the following two lines depending on
;; whether you want the files compiled into FASLs or not:
;; (asdf:operate 'asdf:load-op 'standardize-ulf) ;; Compile and load as necessary
(asdf:operate 'asdf:load-source-op 'standardize-ulf) ;; Doesn't compile
